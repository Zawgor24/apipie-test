...
class Api::V1::UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_v1_user" do
    assert_difference('Api::V1::User.count') do
      post api_v1_users_url, params: { api_v1_user: { age: @api_v1_user.age, name: @api_v1_user.name } }, as: :json
    end
  ...
  test "should update api_v1_user" do
    patch api_v1_user_url(@api_v1_user), params: { api_v1_user: { age: @api_v1_user.age, name: @api_v1_user.name } }, as: :json
    assert_response 200
  end
